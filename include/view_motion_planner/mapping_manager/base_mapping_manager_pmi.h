...
#inlcude <panoptic_mapping/common/input_data.h>

namespace view_motion_planner
{

// Mapping manager with panoptic mapping InputData as input
class BaseMappingManagerPmi : public BaseMappingManager
{
public:
  /// @brief Constructor
  /// @param nh NodeHandle
  ...
  BaseMappingManagerPmi(ros::NodeHandle &nh, ros::NodeHandle &priv_nh, const std::string& map_frame, const std::string& ws_frame, tf2_ros::Buffer &tfBuffer)
